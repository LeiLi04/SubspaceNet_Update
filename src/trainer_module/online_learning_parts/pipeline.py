...
def _run_single_trajectory_online_learning_impl(self, trajectory_idx: int = 0) -> Dict[str, Any]:
    from src.trainer_module.online_learning_parts.pipeline_run import _run_single_trajectory_online_learning_impl as impl
...
def _online_training_window_impl(self, window_time_series, window_sources_num, window_labels, trajectory_idx: int = 0, window_idx: int = 0,
    ...
    from src.trainer_module.online_learning_parts.pipeline_train import _online_training_window_impl as impl
