...
from src.data.trajectory import TrajectoryDataHandler, create_online_learning_dataset
from src.train.training import Trainer, TrainingConfig, TrajectoryTrainer, OnlineTrainer
...
from src.train.sandbox import glrt_changepoint_detection, plot_results
...
class OnlineLearning:
    ...
    def _create_averaged_trajectory_result(self, averaged_metrics: dict) -> TrajectoryResults:
        from src.train.online_learning_parts.pipeline import _create_averaged_trajectory_result_impl
    ...
    def _check_gradients(self, model, step: int, gd_step: int) -> bool:
        from src.train.online_learning_parts.step_processor import _check_gradients_impl
    ...
    def _validate_inputs(self, window_time_series: torch.Tensor, window_sources_num: List[int], 
        ...
        from src.train.online_learning_parts.step_processor import _validate_inputs_impl
    ...
    def _initialize_ekf_filters(self, max_sources: int, window_idx: int = 0, step_idx: int = 0) -> List[ExtendedKalmanFilter1D]:
        from src.train.online_learning_parts.step_processor import _initialize_ekf_filters_impl
    ...
    def _initialize_ekf_state(self, step: int, num_sources_this_step: int, true_angles_this_step: np.ndarray,
        ...
        from src.train.online_learning_parts.step_processor import _initialize_ekf_state_impl
    ...
    def _process_single_step(self, step: int, time_series_steps: torch.Tensor, sources_num_per_step: List[int],
        ...
        from src.train.online_learning_parts.step_processor import _process_single_step_impl
    ...
    def _evaluate_window(self, window_time_series, window_sources_num, window_labels, trajectory_idx: int = 0, window_idx: int = 0,
        ...
        from src.train.online_learning_parts.step_processor import _evaluate_window_impl
    ...
    def _fix_tensor_shape_for_loss(self, tensor: torch.Tensor) -> torch.Tensor:
        from src.train.online_learning_parts.losses import _fix_tensor_shape_for_loss_impl
    ...
    def _calculate_window_training_loss(self, step_results_list: List[Dict], 
        ...
        from src.train.online_learning_parts.losses import _calculate_window_training_loss_impl
    ...
    def _get_optimal_permutation(self, predictions: np.ndarray, true_angles: np.ndarray) -> np.ndarray:
        from src.train.online_learning_parts.losses import _get_optimal_permutation_impl
    ...
    def _get_optimal_permutation_tensor(self, predictions: torch.Tensor, true_angles: torch.Tensor) -> torch.Tensor:
        from src.train.online_learning_parts.losses import _get_optimal_permutation_tensor_impl
    ...
    def _average_online_learning_results_across_trajectories(self, results_list):
        from src.train.online_learning_parts.metrics import _average_online_learning_results_across_trajectories_impl
