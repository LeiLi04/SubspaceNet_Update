#!/usr/bin/env python3
# Train command over multiple SNRs:
# python3 main.py simulate -c run/conf/training_config/Random_basemodel_training_config.yaml -o experiments/results/my_snr_experiment -s snr -v -10 -v -5 -v 0 -v 5 -v 10 --mode training
"""
